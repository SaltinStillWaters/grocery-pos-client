...
const activities = [
    {
        id: 1,
        title: 'New inquiry from Juan dela Cruz',
        time: '2 mins ago',
        color: 'primary',
    },
    {
        id: 2,
        title: 'Listing #1284 approved',
        time: '1 hour ago',
        color: 'success',
    },
    {
        id: 3,
        title: 'Deal closed: BGC Suite',
        time: '3 hours ago',
        color: 'info',
    },
    {
